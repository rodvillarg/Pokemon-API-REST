...
public class PokemonService {
    ...
    public Pokemon obtenerPorId(Long id){
        return pokemonRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("No se encontro el pokemon con el id proporcionado."));
    ...
    public Pokemon actualizarPokemonCompleto(Long id, Pokemon pokemonActualizado) {
        return pokemonRepository.findById(id).map(pokemon -> {
            ...
            return pokemonRepository.save(pokemon);
        }).orElseThrow(() -> new ResourceNotFoundException("No se encontro el pokemon."));
    }
    ...
    public void eliminarPokemon(Long id){
        if(!pokemonRepository.existsById(id)){
            throw new ResourceNotFoundException("El pokemon no se pudo eliminar.");
        }
